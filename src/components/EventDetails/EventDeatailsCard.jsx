  ...
  return (
    <div>
        ...
        <div className="w-full md:w-6/12 p-4 mt-6 md:mt-0 text-center md:text-left">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold font-Fredoka pulse bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500">{EventData.eventname}</h1>
